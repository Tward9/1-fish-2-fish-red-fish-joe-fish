...
function getFishAPI() {
  ...
  fetch(fishURL)
    ...
    .then(function (fishData) {
      ...
      $("#btnList").empty();
      $("#regionList").append(
        $("<li/>").attr("id", "regionHeader").text("NOAA Fisheries Region")
      );
      $("#btnList").append($("<li/>").attr("id", "btnHeader"));
      var alaska = "AK";
      var greater_atlantic = [
        "MN",
        "ND",
        "SD",
        "WI",
      ...
      fishData.forEach(function (fish, i) {
        ...
        if (fish["NOAA Fisheries Region"] == fishRegion) {
          ...
          if (statePic == "CA") {
            if (fish["Source"].includes("Washington to California")) {
              $("#regionList").append(
                $("<li/>")
                  .attr("id", "item_" + i + "_r")
                  .addClass("item_" + i)
                  .text(fish["NOAA Fisheries Region"])
              );
              $("#btnList").append(
                $("<li/>")
                  .attr(
                  ...
                  .append(
                    $("<button/>", {
                      ...
                      id: fish["Species Name"].replace(/ /g, ""),
                      class: "modal-open",
                    }).addClass("item_" + i)
                  )
              );
              $("item_" + i + "_btn").text("test");
              var favoriteCheck = JSON.parse(
                localStorage.getItem(fish["Species Name"]) || "{}"
              ).Species;
              if (favoriteCheck == fish["Species Name"]) {
                $("#" + fish["Species Name"].replace(/ /g, "")).addClass(
            ...
            if (
              fish["Source"].includes("from Washington, Oregon, and California")
            ) {
              $("#regionList").append(
                $("<li/>")
                  .attr("id", "item_" + i + "_r")
            ...
            if (
              fish["Source"].includes("off Washington, Oregon, and California")
            ) {
              $("#regionList").append(
                $("<li/>")
                  .attr("id", "item_" + i + "_r")
          ...
          $(".modal-open").on("click", function (event) {
            ...
            availability = modalObj["Availability"]
              .replace("<p>", "")
              .replace("</p>", "");
            ...
            $("#fishImg").append(
              $("<img/>").attr("src", srcUrl, "alt", altText)
            );
            var savedObj = JSON.parse(
              localStorage.getItem(modalObj["Species Name"]) || "{}"
            ).Species;
